...
INSERT INTO droplets (id, cluster_id, name, region, provider, size, image, status, created_at, ip_address) VALUES
('droplet-1', 'cluster-1', 'web-server-1', 'nyc1', 'demo-cloud', 's-1vcpu-1gb', 'ubuntu-20-04-x64', 'active', '2025-11-20 10:00:00', '192.168.1.1'),
('droplet-2', 'cluster-1', 'db-server-1', 'nyc1', 'demo-cloud', 's-2vcpu-2gb', 'ubuntu-20-04-x64', 'active', '2025-11-20 10:05:00', '192.168.1.2'),
('droplet-3', 'cluster-2', 'staging-web', 'nyc1', 'demo-cloud', 's-1vcpu-1gb', 'ubuntu-20-04-x64', 'active', '2025-11-25 14:00:00', '192.168.1.3'),
('droplet-4', NULL, 'orphan-droplet', 'nyc1', 'demo-cloud', 's-1vcpu-1gb', 'ubuntu-20-04-x64', 'active', '2025-11-27 16:00:00', '192.168.1.4');
